...
[Başla](./quick-start){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHub'da Gör](https://github.com/msotnikov/fitcloak){: .btn .fs-5 .mb-4 .mb-md-0 .mr-2 }
[Patreon'da Destekle](https://www.patreon.com/msotnikov/gift){: .btn .fs-5 .mb-4 .mb-md-0 }

---

## Nasıl çalışır

Fitcloak, **Keycloak'tan bağımsız çalışan** yerel bir sunucudur. Yalnızca Java 17+ gereklidir.

1. Bir tema oluşturur veya düzenlersiniz — standart `.ftl` şablonları, CSS, JS
2. Fitcloak şablonları Keycloak ile aynı kalıtım zincirini kullanarak birleştirir (`Base → Parent → Child`)
3. Test verilerini yerleştirir ve oluşturulan sayfayı tarayıcınıza sunar
4. Tema hazır olduğunda — Keycloak'a kopyalayın ve yönetici konsolunda seçin
5. İsteğe bağlı olarak, herhangi bir web framework ile daha hızlı geliştirme için paketleyicileri (Vite, Webpack, vb.) HMR (Sıcak Modül Değiştirme) amacıyla kullanabilirsiniz
